...
import com.example.user.giftandroidapp.ViewHolder.MenuViewHolder;
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        Intent giftList = new Intent(Home.this,GiftList.class);
                        //because category id is key,so we just get key of this item
                        giftList.putExtra("CategoryId",adapter.getRef(position).getKey());
                        startActivity(giftList);
